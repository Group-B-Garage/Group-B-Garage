...
class CarrosSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('tb_carros')->insertGetId([
            ...
            'car_descrição' => 'The Alfa Romeo 105 and 115 series coupés are a range of cars made by the Italian manufacturer Alfa Romeo from 1963 until 1977, based on a shortened floorpan from the Giulia saloon. They were the successors to the Giulietta Sprint coupé. ',
            'car_preco' => '720000',
            'car_mar_codigo' => '9',
            'car_cor_codigo' => '4',
            'car_cat_codigo' => '1',
        ...
        DB::table('tb_carros')->insertGetId([
            ...
            'car_descrição' => 'The Porsche 944 is a sports car manufactured by German automobile manufacturer Porsche from 1982 to 1991. A front-engine, rear-wheel drive mid-level model based on the 924 platform, the 944 was available in coupé or cabriolet body styles, with either naturally aspirated or turbocharged engines. With over 163,000 cars produced, the 944 was the most successful sports car in Porsches history until the introductions of the Boxster and 997 Carrera.',
            'car_preco' => '260000',
            'car_mar_codigo' => '1',
            'car_cor_codigo' => '2',
            'car_cat_codigo' => '1',
        ...
        DB::table('tb_carros')->insertGetId([
            ...
            'car_descrição' => 'O Subaru WRX é um carro compacto esportivo com tração nas quatro rodas fabricado pela Subaru, originalmente baseado no Impreza criado para o Campeonato Mundial de Rally em 1992. [1] Subaru afirmou que o nome WRX significa "World Rally eXperimental".',
            'car_preco' => '190000',
            'car_mar_codigo' => '12',
            'car_cor_codigo' => '3',
            'car_cat_codigo' => '1',
