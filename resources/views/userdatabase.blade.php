...
<html lang="en">
  <head>
     <title>Funcionários Cadastrados - Group B Garage</title>
    <meta charset="utf-8">
            ...
            <div class="container-fluid">
              ...
              <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="#">Veículos Cadastrados</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="#">Funcionários Cadastrados</a>
                  </li>
                  </ul>
              </div>
            </div>
...
">
    ...
    <table class="table ">
        ...
        @foreach($users as $user)
            <tr>
                ...
                <form action="/user/{{$user->id}}" method="POST">
                    @method('delete')
                    @csrf
                    <button type="submit" class="btn btn-danger botoeseditar">Remover Funcionário</button>
                    </form>
        ...
        @else
        <p>Não tens funcionários</p>
        @endif
        </tbody>
      </table>

        <a href="/addcar"> <button type="button" class="btn w-100 btn-dark">Adicionar Funcionário</button></a>
