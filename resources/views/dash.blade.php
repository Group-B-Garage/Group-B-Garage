<html>
    ...
    <title>Veiculos Cadastrados - Group B Garage</title>
...
<h3 style="color: #999; margin: 20px"> Olá, Elder Elder </h3>

</div>

<div class="mt-5 w-100 d-flex justify-content-center text-center" >
 
<h3 style="color: #999;"> Veiculos Cadastrados </h3>
    ...
    <div class="col">
      <div class="card carddemo ">
        ...
        <div class="card-body">
          ...
          <p class="card-text">Cor - {{$carro->cor->cor_cor}}</p>
          <p class="card-text">Ano - {{$carro->car_ano}}</p>
          <p class="card-text">Potência - {{$carro->car_potencia}}</p>
          <p class="card-text">Cilindrada - {{$carro->car_cilindrada}}</p>
          <p class="card-text">Motor {{$carro->motor->tip_tipo_motor}}</p>
          <p class="card-text">Posição do motor - {{$carro->posicao_motor->pos_posicao_motor}}</p>
          <p class="card-text">Tração {{$carro->tracao->tra_tração}}</p>
          <p class="card-text">Categoria - {{$carro->categoria->cat_categoria}}</p>
          <p class="card-text">{{$carro->car_kmrodados}} kilometros rodados</p>
            <div class="">
              <div class="cardbt">
                <a href="https://groupbgarage.herokuapp.com/car/{{$carro->car_codigo}}" class="btn btn-primary  w-100" role="button" aria-pressed="true">Atualizar Dados do Veiculo</a>
                <br>
                <br>
                <a href="https://groupbgarage.herokuapp.com/car/{{$carro->car_codigo}}" class="btn btn-danger  w-100" role="button" aria-pressed="true">Retirar Veiculo do Site</a>
                  </div>
            </div>
        </div>
      </div>
