...
<html lang="en">
  <head>
     <title>Adicionar Novo Funcionário - Group B Garage</title>
    <meta charset="utf-8">
            ...
            <div class="container-fluid">
              ...
              <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav">
                  ...
                  <li class="nav-item">
                    <a class="nav-link" aria-current="page" href="/admindashboard">Veiculos Cadastrados</a>
                  </li>
                  <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="#">Adicionar Funcionário</a>
                  </li>
                  </ul>
              </div>
            </div>
...
<div class="row g-3">
    ...
    <div class="col-sm-6">
      ...
      <input type="text" class="form-control" id="####" name="email" placeholder="" value="" required>
      <div class="invalid-feedback">
        ?????????
      </div>
    </div>
    ...
    <div class="col-12">
      <label for="password" class="form-label">Senha</label>
        <input type="text" class="form-control" id="####" name="password" placeholder="" required>
      <div class="invalid-feedback">
         ????????
        </div>
    </div>
    ...
    <div class="col-12">
        <input type="hidden" id="####" name="is_admin" value="0" >
      <div class="invalid-feedback">
         ????????
        </div>
    </div>
    ...
    <div class="col-12">
      <label for="is_admin" class="form-label">Pertence a Gerência?</label>
        <input type="checkbox" class="form-check-input" id="####" name="is_admin" value="1" >
      <div class="invalid-feedback">
         ????????
        </div>
    </div>

    <button class="w-100 btn btn-dark btn-md mt-3" type="submit">Adicionar Novo Funcionário</button>
    ...
    <footer class="page-footer font-small blue pt-4 pl-5 pr-5" style="background-color: rgb(33,37,41);">
