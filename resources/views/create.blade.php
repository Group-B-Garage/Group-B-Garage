...
<html lang="en">
  <head>
     <title>Adicionar Novo Veículo - Group B Garage</title>
    <meta charset="utf-8">
            ...
            <div class="container-fluid">
              ...
              <div class="collapse navbar-collapse" id="navbarNavDropdown">
                <ul class="navbar-nav">
                  ...
                  <li class="nav-item">
                    <a class="nav-link active" aria-current="page" href="#">Adicionar Veículo</a>
                  </li>
                  </ul>
              </div>
            </div>
...
<div class="row g-3">
    ...
    <button class="w-100 btn btn-dark btn-md mt-3" type="submit">Adicionar Novo Veículo</button>
